  ...
  <Svg viewBox="0 0 21 15" width={21} height={15} {...props}>
    ...
    <G fill="none" fillRule="evenodd">
      ...
      <G transform="translate(15 8)">
        ...
        <Circle fill="#225DA4" mask="url(#GS_svg__r)" cx={2.5} cy={2.5} r={1} />
        <Circle fill="#225DA4" mask="url(#GS_svg__r)" cx={0.5} cy={1.5} r={1} />
        <Path fill="url(#GS_svg__s)" mask="url(#GS_svg__r)" d="M0 0h3L1.5 3z" />
        <Ellipse
          fill="url(#GS_svg__t)"
          mask="url(#GS_svg__r)"
          cx={1.5}
